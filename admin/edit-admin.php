...
$sql=mysqli_query($con,"update admin set Fullname='$Fullname',username='$username',roleLevel='$roleLevel',password='$password',updationDate='$currentTime' where admin.id='$getId'");
...
<div class="addAccount">
  <div class="well">
    ...
    button.close{color: white;}
      ...
      <?php
  $query=mysqli_query($con,"select * from admin where id='$getId'");
  $cnt=1;
  while($row=mysqli_fetch_array($query))
  {
      ...
      <form action="" name="insertproduct" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-3">
            ...
            <input type="text" name="username" class="form-control" placeholder="Fullname" value="<?php echo htmlentities($row['username']);?>">
          </div>
          <div class="col-lg-3">
