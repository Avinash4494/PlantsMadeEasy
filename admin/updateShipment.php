...
$query=mysqli_query($con,"insert into ordertrackhistory(orderId,status,remark,order_location) values('$oid','$status','$remark','$order_location')");
...
<html>
  ...
  <div class="row">
    <div class="col-lg-10">
      <h3><i class="fa fa-archive"></i> Update Order Status</h3>
    </div> 
    <div class="col-lg-2">
      ...
      <div class="form-group">
       ...
       <select name="status" class="form-control" required="required" >
        ...
        <div class="col-lg-3">
          <div class="row">
            <div class="col-lg-6">
               <input type="submit" name="submit2"  value="update" class="buttonInsert" size="40" style="cursor: pointer;" />
            </div>
            <div class="col-lg-6">
              <input name="Submit2" type="submit" class="buttonInsert" value="Close" onClick="return f2();" style="cursor: pointer;"  />
            </div>
            <style>
              .buttonInsert {
