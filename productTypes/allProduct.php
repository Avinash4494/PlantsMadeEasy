...
<!-- CATEGORY 8 SUB 15 -->
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp" style="margin-top: -35px;">
			<div class="">
			...
			<style>
				...
				h4.productTitle{font-size: 1.3em;}
			</style>
...
<!-- CATEGORY 8 SUB 15 -->
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp" style="margin-top: -95px;">
			<div class="">
			   <h4 class="productTitle">Grass Seeds &nbsp  
			</div>
			<div class="tab-content outer-top-xs">
				<div class="tab-pane in active" id="all">			
					<div class="product-slider">
